    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Tambah Petugas</h4>
        ...
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" id="AddPetugasForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Nama Petugas" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">No WA</label>
                                            <input type="number" pattern="[0-9]*" id="handphone" inputmode="numeric" class="form-control" name="handphone" placeholder="" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
    ...
    <script>
        $("#AddPetugasForm").on("submit", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: '/petugas/post',
                data: {"_token": "{{ csrf_token() }}", pdm_id:pdm_id, name:name, handphone:handphone, password:password},
                beforeSend : function(xhr, opts){
                    $(".place-loader").addClass("loadingSpinner");
                    $(".btnSubmit").addClass("d-flex justify-content-center gap-3");
                },
                success: function( response ) {
                    toastr.success('Data petugas berhasil ditambahkan!');
